    ...
    try {
        ...
        $stmt = $pdo->prepare("
            UPDATE job_orders SET
                ...
                aircon_hp_id = :aircon_hp_id,
                cleaning_service_id = :cleaning_service_id,
                assigned_technician_id = :assigned_technician_id,
                secondary_technician_id = :secondary_technician_id,
        ...
        $stmt->bindValue(':aircon_hp_id', $_POST['aircon_hp_id'] ?: null);
        $stmt->bindValue(':cleaning_service_id', $_POST['cleaning_service_id'] ?: null);
