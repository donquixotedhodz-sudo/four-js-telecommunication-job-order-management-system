...
try {
    ...
    // Apply sorting
    $valid_sort_fields = ['created_at', 'customer_name', 'service_type', 'status', 'price'];
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                // echo "<!-- Debug: secondary_technician_name = '" . ($order['secondary_technician_name'] ?? 'NULL') . "' -->";
                                                if (!empty($order['secondary_technician_name'])): ?>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?= !empty($order['secondary_technician_profile']) ? '../' . htmlspecialchars($order['secondary_technician_profile']) : 'https://ui-avatars.com/api/?name=' . urlencode($order['secondary_technician_name']) . '&background=28a745&color=fff' ?>" 
                                                             alt="Secondary Technician" 
                                                             class="rounded-circle me-2" 
                                                             width="24" 
                                                             height="24"
                                                             style="object-fit: cover;">
                                                        <span><?= htmlspecialchars($order['secondary_technician_name']) ?></span>
                                                    </div>
                                                <?php else: ?>
