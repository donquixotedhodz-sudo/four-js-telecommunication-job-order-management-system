...
try {
    ...
    if (!empty($search_customer)) {
        $sql .= " AND (jo.customer_name LIKE ? OR jo.job_order_number LIKE ?)";
...
<body>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="GET" class="row g-3">
                            <div class="col-md-4">
                                <label for="search_customer" class="form-label">Search by Customer Name or Ticket Number</label>
                                <input type="text" class="form-control" id="search_customer" name="search_customer" 
                                       value="<?= htmlspecialchars($search_customer) ?>" placeholder="Enter customer name or ticket number...">
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-search while typing with debouncing
            ...
            function performSearch() {
                ...
                if (searchTerm) {
                    currentUrl.searchParams.set('search_customer', searchTerm);
                } else {
                    currentUrl.searchParams.delete('search_customer');
                }
